...
<<<<<<< HEAD
        tx, '0x743f85a8fe45a4bb52095bbcc24f9a2e0c649f47f944e52a984e4406e55fecba')
=======
...
<<<<<<< HEAD
#     tx = contract.functions.addState(product_id, time_stamp, loc).buildTransaction({
#         'from': signer_account, 'nonce': nonce})
